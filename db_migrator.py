...
for row in scur.fetchall():
	pcur.execute('INSERT INTO dbv_parts (number, title, update_number, active) VALUES (?, ?, ?, ?)' % (row[0], row[1], 1, True) )
	pgconn.commit()
...
for row in scur.fetchall():
	pcur.execute('INSERT INTO dbv_subparts (letter, part_number, title, update_number, active)' % 
...
for row in scur.fetchall():
	pcur.execute('INSERT INTO dbv_standards number, title, subpart_letter, part_number, update_number, active' %
...
for row in scur.fetchall():
	pcur.execute('INSERT INTO dbv_violations number, description, standard_number, update_number, active' %
		(row[0], row[1], row[2], 1, True))
	pgconn.commit()
...
for row in scur.fetchall():
	pcur.execute('INSERT INTO dbv_violation_2s number, description, violation_number, update_number, active' %
		(row[0], row[1], row[2], 1, True))
	pgconn.commit()
...
for row in scur.fetchall():
	pcur.execute('INSERT INTO dbv_violation_3s number, description, violation2_number, update_number, active' %
		(row[0], row[1], row[2], 1, True))
	pgconn.commit()
...
for row in scur.fetchall():
	pcur.execute('INSERT INTO dbv_violation_3s number, description, violation3_number, update_number, active' %
		(row[0], row[1], row[2], 1, True))
	pgconn.commit()
